...
if(isset($_POST["processform"])){
  ...
  $sixfield = mysqli_real_escape_string($connection, sanitize($_POST["tel"]));
   ...
   $sql = "INSERT INTO Client (nom, prenom,email,date,pays,cin,tel,checkbox) VALUES ('$firstfield', '$secondfield', '$thirdfield', '$fourthfield','$country','$fivefield','$sixfield', '$check')";
...
<body class="">
  ...
  <div id="tete">
    ...
    <section class="box shadow clearfix">
        <form action="form.php" method="post" class="form-default" name="Form" onsubmit="return validateForm()">
